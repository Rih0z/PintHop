...
フェーズ0（マイクロMVP）では、PintHopの核心機能である「リアルタイム存在共有」と「高評価ビール発見」の基盤となる要素を最小限の機能セットで実装します。このフェーズでは、シアトル地域限定のブルワリーマップとリアルタイムプレゼンス共有の基本機能に焦点を当て、8週間での完成を目指します。
...
フェーズ0（マイクロMVP）では、PintHopの核心的な価値提案である「次の一杯を見つける」個人体験と「自然に友達とつながる」社会体験の基盤機能を最小限の形で実装します。8週間のタイムラインで、シアトル地域限定のブルワリーマップとリアルタイムプレゼンス共有の基本機能を提供し、初期ユーザーからのフィードバックを収集します。
